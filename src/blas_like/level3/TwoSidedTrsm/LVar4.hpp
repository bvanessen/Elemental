...
void LVar4( UnitOrNonUnit diag, Matrix<F>& A, const Matrix<F>& L )
{
    ...
    for( Int k=0; k<n; k+=bsize )
    {
        ...
        // A20 := A20 - L21 A10
        Gemm( Orientation::NORMAL, Orientation::NORMAL, F(-1), L21, A10, F(1), A20 );
        ...
        Her2k( UpperOrLower::LOWER, Orientation::NORMAL, F(-1), L21, A21, Base<F>(1), A22 );
  ...
  const AbstractDistMatrix<F>& LPre )
{
    ...
    DistMatrix<F,Dist::STAR,Dist::MC  > A21Trans_STAR_MC(g);
    ...
    for( Int k=0; k<n; k+=bsize )
    {
        ...
        LocalGemm( Orientation::NORMAL, Orientation::NORMAL, F(-1), L21_MC_STAR, A10_STAR_MR, F(1), A20 );
        ...
        Zero( Y21_VC_STAR );
        Hemm
        ( LeftOrRight::RIGHT, UpperOrLower::LOWER,
        ...
        LocalTrr2k
        ( UpperOrLower::LOWER, Orientation::NORMAL, Orientation::NORMAL, Orientation::TRANSPOSE, Orientation::NORMAL,
