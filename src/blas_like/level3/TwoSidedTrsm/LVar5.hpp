...
void LVar5( UnitOrNonUnit diag, Matrix<F>& A, const Matrix<F>& L )
{
    ...
    for( Int k=0; k<n; k+=bsize )
    {
        ...
        // A21 := inv(L22) A21
        Trsm( LeftOrRight::LEFT, UpperOrLower::LOWER, Orientation::NORMAL, diag, F(1), L22, A21 );
    }
}
  ...
  const AbstractDistMatrix<F>& LPre )
{
    ...
    for( Int k=0; k<n; k+=bsize )
    {
        ...
        LocalTrr2k
        ( UpperOrLower::LOWER, Orientation::NORMAL, Orientation::NORMAL, Orientation::NORMAL, Orientation::NORMAL,
