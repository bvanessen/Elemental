...
void UVar4( UnitOrNonUnit diag, Matrix<F>& A, const Matrix<F>& U )
{
    ...
    for( Int k=0; k<n; k+=bsize )
    {
        ...
        // A02 := A02 - A01 U12
        Gemm( Orientation::NORMAL, Orientation::NORMAL, F(-1), A01, U12, F(1), A02 );

        // Y12 := A11 U12
        Y12.Resize( A12.Height(), A12.Width() );
        Zero( Y12 );
        Hemm( LeftOrRight::LEFT, UpperOrLower::UPPER, F(1), A11, U12, F(0), Y12 );
        ...
        Her2k( UpperOrLower::UPPER, Orientation::ADJOINT, F(-1), A12, U12, Base<F>(1), A22 );
  ...
  const AbstractDistMatrix<F>& UPre )
{
    ...
    for( Int k=0; k<n; k+=bsize )
    {
        ...
        Zero( Y12_STAR_VR );
        Hemm
        ( LeftOrRight::LEFT, UpperOrLower::UPPER,
        ...
        LocalTrr2k
        ( UpperOrLower::UPPER, Orientation::ADJOINT, Orientation::TRANSPOSE, Orientation::ADJOINT, Orientation::NORMAL,
