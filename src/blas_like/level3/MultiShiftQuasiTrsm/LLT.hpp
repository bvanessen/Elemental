  ...
  const Matrix<F>& L, const Matrix<F>& shifts, Matrix<F>& X )
{
    ...
    while( true )
    {
        ...
        Gemm( Orientation::TRANSPOSE, Orientation::NORMAL, F(-1), L10, X1, F(1), X0 );
        ...
        AbstractDistMatrix<F>& XPre )
{
    ...
    while( true )
    {
        ...
        ( LeftOrRight::LEFT, UpperOrLower::LOWER, orientation, F(1), L11_STAR_STAR, shifts, X1_STAR_VR );
        ...
        DistMatrix<F,colDist,Dist::STAR>& X )
{
    ...
    while( true )
    {
        ...
        L11_STAR_STAR = L11;
        LocalMultiShiftQuasiTrsm
        ( LeftOrRight::LEFT, UpperOrLower::LOWER, orientation, F(1),
