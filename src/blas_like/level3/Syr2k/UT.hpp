  ...
  bool conjugate=false )
{
    ...
    for( Int k=0; k<r; k+=bsize )
    {
        ...
        LocalTrr2k
        ( UpperOrLower::UPPER, orientation, Orientation::TRANSPOSE, orientation, Orientation::TRANSPOSE,
  ...
  Int blockSize=2000 )
{
    ...
    for( Int kOuter=0; kOuter<n; kOuter+=blockSize )
    {
        ...
        Syr2k
        ( UpperOrLower::UPPER, Orientation::TRANSPOSE, alpha, A1.Matrix(), B1.Matrix(), Z.Matrix(),
          conjugate );
