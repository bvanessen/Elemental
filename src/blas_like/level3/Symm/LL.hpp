        ...
        DistMatrix<T,Dist::MR,  Dist::STAR>& Z_MR_STAR )
{
    ...
    for( Int k=0; k<m; k+=bsize )
    {
        ...
        LocalGemm
        ( Orientation::NORMAL, orientation, alpha, A21, B1Trans_STAR_MR, T(1), Z2_MC_STAR );

        LocalGemm
        ( orientation, Orientation::NORMAL, alpha, A21, B2_MC_STAR, T(1), Z1_MR_STAR );
    }
}
  ...
  bool conjugate=false )
{
    ...
    for( Int k=0; k<m; k+=bsize )
    {
        ...
        AB1_MC_STAR = AB1;
        A1L_STAR_MC = A1L;
        MakeTrapezoidal( UpperOrLower::LOWER, AB1_MC_STAR );
        MakeTrapezoidal( UpperOrLower::LOWER, A1L_STAR_MC, k-1 );
