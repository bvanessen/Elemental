...
{
    EL_DEBUG_CSE
    DistMatrix<T,Dist::STAR,Dist::VR> A_STAR_VR( A );
    DistMatrix<T,Dist::STAR,Dist::VC> A_STAR_VC( this->Grid() );
...
DM& DM::operator=( const DistMatrix<T,Dist::MC,Dist::STAR>& A )
{
    ...
    DistMatrix<T,Dist::STAR,Dist::VR> A_STAR_VR( A_MC_MR );
    A_MC_MR.Empty();
...
DM& DM::operator=( const DistMatrix<T,Dist::STAR,Dist::MR>& A )
{
    ...
    {
        DistMatrix<T,Dist::STAR,Dist::VR> A_STAR_VR( A );
        DistMatrix<T,Dist::STAR,Dist::VC> A_STAR_VC( grid );
        A_STAR_VC.AlignRowsWith(*this);
        A_STAR_VC = A_STAR_VR;
        A_STAR_VR.Empty();
        *this = A_STAR_VC;
...
DM& DM::operator=( const DistMatrix<T,Dist::VC,Dist::STAR>& A )
{
    ...
    DistMatrix<T,Dist::MR,Dist::MC> A_MR_MC( this->Grid() );
...
{
    EL_DEBUG_CSE
    DistMatrix<T,Dist::MR,Dist::MC> A_MR_MC( A.Grid() );
