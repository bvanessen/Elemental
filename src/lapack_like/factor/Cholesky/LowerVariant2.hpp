...
*/
#ifndef EL_CHOLESKY_LOWER_VARIANT2_HPP
#define EL_CHOLESKY_LOWER_VARIANT2_HPP
...
template<typename F>
void LowerVariant2Blocked( Matrix<F>& A )
{
    EL_DEBUG_CSE
    EL_DEBUG_ONLY(
      if( A.Height() != A.Width() )
...
template<typename F>
void LowerVariant2Blocked( AbstractDistMatrix<F>& APre )
{
    EL_DEBUG_CSE
    EL_DEBUG_ONLY(
...
#endif // ifndef EL_CHOLESKY_LOWER_VARIANT2_HPP
