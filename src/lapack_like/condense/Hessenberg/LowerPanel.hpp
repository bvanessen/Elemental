  ...
  DistMatrix<F,Dist::STAR,Dist::STAR>& G_STAR_STAR )
{
    ...
    EL_DEBUG_ONLY(
      AssertSameGrids
      ( A, householderScalars, U_MC_STAR, U_MR_STAR, V_MR_STAR, G_STAR_STAR );
    ...
    for( Int k=0; k<nU; ++k )
    {
        ...
        auto g01_STAR      = G_STAR_STAR( ind0, ind1 );
        ...
        // Store u21 := | 1   |
        //              | v^T |
        Transpose( a12, u21_MC );
        Transpose( a12, u21_MR );
        u21_MC.Set(0,0,F(1));
        u21_MR.Set(0,0,F(1));
