...
class DistMatrix<Ring,Dist::MR,Dist::MC,DistWrap::BLOCK> : public BlockMatrix<Ring>
{
public:
    typedef AbstractDistMatrix<Ring> absType;
    typedef BlockMatrix<Ring> blockType;
    typedef DistMatrix<Ring,Dist::MR,Dist::MC,DistWrap::BLOCK> type;
    typedef DistMatrix<Ring,Dist::MC,Dist::MR,DistWrap::BLOCK> transType;
