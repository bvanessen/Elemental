...
class DistMatrix<Ring,Dist::CIRC,Dist::CIRC,DistWrap::BLOCK>
...
public:
    ...
    typedef DistMatrix<Ring,Dist::CIRC,Dist::CIRC,DistWrap::BLOCK> type;
    typedef DistMatrix<Ring,Dist::CIRC,Dist::CIRC,DistWrap::BLOCK> transType;
    typedef DistMatrix<Ring,Dist::CIRC,Dist::CIRC,DistWrap::BLOCK> diagType;
    ...
    template<Dist colDist,Dist rowDist>
    type& operator=(
        const DistMatrix<Ring,colDist,rowDist,DistWrap::ELEMENT>& A);
