...
*/
#ifndef EL_DISTMATRIX_BLOCKCYCLIC_STAR_VR_HPP
#define EL_DISTMATRIX_BLOCKCYCLIC_STAR_VR_HPP
...
class DistMatrix<Ring,Dist::STAR,Dist::VR,DistWrap::BLOCK> : public BlockMatrix<Ring>
{
public:
    typedef AbstractDistMatrix<Ring> absType;
    typedef BlockMatrix<Ring> blockType;
    typedef DistMatrix<Ring,Dist::STAR,Dist::VR,DistWrap::BLOCK> type;
    typedef DistMatrix<Ring,Dist::VR,Dist::STAR,DistWrap::BLOCK> transType;
    typedef DistMatrix<Ring,Dist::VR,Dist::STAR,DistWrap::BLOCK> diagType;
...
#endif // ifndef EL_DISTMATRIX_BLOCKCYCLIC_STAR_VR_HPP
