...
*/
#ifndef EL_DISTMATRIX_BLOCKCYCLIC_MC_MR_HPP
...
class DistMatrix<Ring,Dist::MC,Dist::MR,DistWrap::BLOCK>
...
public:
    ...
    typedef DistMatrix<Ring,Dist::MC,Dist::MR,DistWrap::BLOCK> type;
    typedef DistMatrix<Ring,Dist::MR,Dist::MC,DistWrap::BLOCK> transType;
...
#endif // ifndef EL_DISTMATRIX_BLOCKCYCLIC_MC_MR_HPP
