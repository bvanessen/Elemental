...
*/
#ifndef EL_DISTMATRIX_BLOCKCYCLIC_STAR_STAR_HPP
#define EL_DISTMATRIX_BLOCKCYCLIC_STAR_STAR_HPP
...
class DistMatrix<Ring,Dist::STAR,Dist::STAR,DistWrap::BLOCK> : public BlockMatrix<Ring>
{
public:
    // Typedefs
    // ========
    ...
    typedef DistMatrix<Ring,Dist::STAR,Dist::STAR,DistWrap::BLOCK> type;
    typedef DistMatrix<Ring,Dist::STAR,Dist::STAR,DistWrap::BLOCK> transType;
    typedef DistMatrix<Ring,Dist::STAR,Dist::STAR,DistWrap::BLOCK> diagType;
...
#endif // ifndef EL_DISTMATRIX_BLOCKCYCLIC_STAR_STAR_HPP
