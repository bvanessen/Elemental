...
*/
#ifndef EL_DISTMATRIX_BLOCKCYCLIC_STAR_MD_HPP
#define EL_DISTMATRIX_BLOCKCYCLIC_STAR_MD_HPP
...
class DistMatrix<Ring,Dist::STAR,Dist::MD,DistWrap::BLOCK> : public BlockMatrix<Ring>
{
public:
    typedef AbstractDistMatrix<Ring> absType;
    typedef BlockMatrix<Ring> blockType;
    typedef DistMatrix<Ring,Dist::STAR,Dist::MD,DistWrap::BLOCK> type;
    typedef DistMatrix<Ring,Dist::MD,Dist::STAR,DistWrap::BLOCK> transType;
...
#endif // ifndef EL_DISTMATRIX_BLOCKCYCLIC_STAR_MD_HPP
