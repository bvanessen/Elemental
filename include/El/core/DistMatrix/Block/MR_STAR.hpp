...
class DistMatrix<Ring,Dist::MR,Dist::STAR,DistWrap::BLOCK> : public BlockMatrix<Ring>
{
public:
    typedef AbstractDistMatrix<Ring> absType;
    typedef BlockMatrix<Ring> blockType;
    typedef DistMatrix<Ring,Dist::MR,Dist::STAR,DistWrap::BLOCK> type;
    typedef DistMatrix<Ring,Dist::STAR,Dist::MR,DistWrap::BLOCK> transType;
