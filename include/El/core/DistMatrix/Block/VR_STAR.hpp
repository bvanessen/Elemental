...
class DistMatrix<Ring,Dist::VR,Dist::STAR,DistWrap::BLOCK> : public BlockMatrix<Ring>
{
public:
    typedef AbstractDistMatrix<Ring> absType;
    typedef BlockMatrix<Ring> blockType;
    typedef DistMatrix<Ring,Dist::VR,Dist::STAR,DistWrap::BLOCK> type;
    typedef DistMatrix<Ring,Dist::STAR,Dist::VR,DistWrap::BLOCK> transType;
