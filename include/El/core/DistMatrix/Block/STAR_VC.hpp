...
*/
#ifndef EL_DISTMATRIX_BLOCKCYCLIC_STAR_VC_HPP
#define EL_DISTMATRIX_BLOCKCYCLIC_STAR_VC_HPP
...
class DistMatrix<Ring,Dist::STAR,Dist::VC,DistWrap::BLOCK> : public BlockMatrix<Ring>
{
public:
    typedef AbstractDistMatrix<Ring> absType;
    typedef BlockMatrix<Ring> blockType;
    typedef DistMatrix<Ring,Dist::STAR,Dist::VC,DistWrap::BLOCK> type;
    typedef DistMatrix<Ring,Dist::VC,Dist::STAR,DistWrap::BLOCK> transType;
    typedef DistMatrix<Ring,Dist::VC,Dist::STAR,DistWrap::BLOCK> diagType;
...
#endif // ifndef EL_DISTMATRIX_BLOCKCYCLIC_STAR_VC_HPP
