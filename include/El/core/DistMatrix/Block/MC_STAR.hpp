...
class DistMatrix<Ring,Dist::MC,Dist::STAR,DistWrap::BLOCK> : public BlockMatrix<Ring>
{
public:
    typedef AbstractDistMatrix<Ring> absType;
    typedef BlockMatrix<Ring> blockType;
    typedef DistMatrix<Ring,Dist::MC,Dist::STAR,DistWrap::BLOCK> type;
    typedef DistMatrix<Ring,Dist::STAR,Dist::MC,DistWrap::BLOCK> transType;
