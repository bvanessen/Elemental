...
class DistMatrix<Ring,Dist::VR,Dist::STAR> : public ElementalMatrix<Ring>
{
public:
    // Typedefs
    // ========
    ...
    typedef DistMatrix<Ring,Dist::VR,Dist::STAR> type;
    typedef DistMatrix<Ring,Dist::STAR,Dist::VR> transType;
...
#endif // ifndef EL_DISTMATRIX_ELEMENTAL_VR_STAR_HPP
