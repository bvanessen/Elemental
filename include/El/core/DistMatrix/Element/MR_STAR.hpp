...
class DistMatrix<Ring,Dist::MR,Dist::STAR> : public ElementalMatrix<Ring>
{
public:
    // Typedefs
    // ========
    ...
    typedef DistMatrix<Ring,Dist::MR,Dist::STAR> type;
    typedef DistMatrix<Ring,Dist::STAR,Dist::MR> transType;
