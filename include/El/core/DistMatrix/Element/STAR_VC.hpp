...
class DistMatrix<Ring,Dist::STAR,Dist::VC> : public ElementalMatrix<Ring>
{
public:
    // Typedefs
    // ========
    ...
    typedef DistMatrix<Ring,Dist::STAR,Dist::VC> type;
    typedef DistMatrix<Ring,Dist::VC,Dist::STAR> transType;
    typedef DistMatrix<Ring,Dist::VC,Dist::STAR> diagType;
...
#endif // ifndef EL_DISTMATRIX_ELEMENTAL_STAR_VC_HPP
