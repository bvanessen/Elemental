...
class DistMatrix<Ring,Dist::VC,Dist::STAR> : public ElementalMatrix<Ring>
{
public:
    // Typedefs
    // ========
    ...
    typedef DistMatrix<Ring,Dist::VC,Dist::STAR> type;
    typedef DistMatrix<Ring,Dist::STAR,Dist::VC> transType;
