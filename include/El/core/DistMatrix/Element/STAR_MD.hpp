...
class DistMatrix<Ring,Dist::STAR,Dist::MD> : public ElementalMatrix<Ring>
{
public:
    // Typedefs
    // ========
    ...
    typedef DistMatrix<Ring,Dist::STAR,Dist::MD> type;
    typedef DistMatrix<Ring,Dist::MD,Dist::STAR> transType;
