...
class DistMatrix<Ring,Dist::MC,Dist::STAR> : public ElementalMatrix<Ring>
{
public:
    // Typedefs
    // ========
    ...
    typedef DistMatrix<Ring,Dist::MC,Dist::STAR> type;
    typedef DistMatrix<Ring,Dist::STAR,Dist::MC> transType;
