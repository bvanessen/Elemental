...
class DistMatrix<Ring,Dist::STAR,Dist::VR> : public ElementalMatrix<Ring>
{
public:
    // Typedefs
    // ========
    ...
    typedef DistMatrix<Ring,Dist::STAR,Dist::VR> type;
    typedef DistMatrix<Ring,Dist::VR,Dist::STAR> transType;
    typedef DistMatrix<Ring,Dist::VR,Dist::STAR> diagType;
...
#endif // ifndef EL_DISTMATRIX_ELEMENTAL_STAR_VR_HPP
