...
class DistMatrix<Ring,Dist::STAR,Dist::MR> : public ElementalMatrix<Ring>
{
public:
    // Typedefs
    // ========
    ...
    typedef DistMatrix<Ring,Dist::STAR,Dist::MR> type;
    typedef DistMatrix<Ring,Dist::MR,Dist::STAR> transType;
    typedef DistMatrix<Ring,Dist::MR,Dist::STAR> diagType;
