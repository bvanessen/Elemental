...
class DistMatrix<Ring,Dist::MD,Dist::STAR> : public ElementalMatrix<Ring>
{
public:
    // Typedefs
    // ========
    ...
    typedef DistMatrix<Ring,Dist::MD,Dist::STAR> type;
    typedef DistMatrix<Ring,Dist::STAR,Dist::MD> transType;
...
#endif // ifndef EL_DISTMATRIX_ELEMENTAL_MD_STAR_HPP
