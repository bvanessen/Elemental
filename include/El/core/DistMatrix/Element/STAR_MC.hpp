...
class DistMatrix<Ring,Dist::STAR,Dist::MC> : public ElementalMatrix<Ring>
{
public:
    // Typedefs
    // ========
    ...
    typedef DistMatrix<Ring,Dist::STAR,Dist::MC> type;
    typedef DistMatrix<Ring,Dist::MC,Dist::STAR> transType;
    typedef DistMatrix<Ring,Dist::MC,Dist::STAR> diagType;
...
#endif // ifndef EL_DISTMATRIX_ELEMENTAL_STAR_MC_HPP
