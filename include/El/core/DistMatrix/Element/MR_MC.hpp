...
class DistMatrix<Ring,Dist::MR,Dist::MC> : public ElementalMatrix<Ring>
{
public:
    // Typedefs
    // ========
    ...
    typedef DistMatrix<Ring,Dist::MR,Dist::MC> type;
    typedef DistMatrix<Ring,Dist::MC,Dist::MR> transType;
